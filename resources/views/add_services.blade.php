...
<div class="container-fluid container-xl d-flex align-items-center justify-content-between">
  ...
  <!-- <a href="#about" class="get-started-btn scrollto">Login</a> -->
   ...
   <!-- choose date -->
   <center><h1 style="color: #8A191D; margin-top: 30px;">Add Services</h1>
    ...
    <div class="image-container">
        <img src="{{ asset('images/service.png') }}" alt="Side Image">
    </div>
    <div class="form-container">
      <h2 style="text-align: center; color: #8A191D;">Introduce New Services</h2>
      <form method="post" action="{{route('addService.admin')}}" class="form" id="chooseDate">
      @csrf
        <div class="date-picker" style="margin-top: 40px">
          <label for="service" class="label">Type of Service:</label>
          <input type="text" style="margin-top:10px; width:300px" class="input-value" id="service" name="services" required>
        </div>
  ...
  -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmationForm.addEventListener('submit', function(event) {
            var confirmationMessage = "Are you sure you want to add this service?";
